...
<section id="m2">
<h2>2. ログイン方法</h2>
<div class="manual-note"><strong>URLについて</strong>お問い合わせフォーム（お客様向けの画面）には、この管理画面へのリンクは設置されていません。一般の訪問者の目に触れないようにするためです。管理画面をお使いになる際は、下記のURLを直接ブラウザに入力するか、ブックマークしてご利用ください。</div>
<ol>
